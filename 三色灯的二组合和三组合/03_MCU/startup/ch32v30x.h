...
typedef enum IRQn
{
 ...
 /******  RISC-V specific Interrupt Numbers *********************************************************/
  ...
  OTG_FS_IRQn                 = 83,      /* OTG global Interrupt                                 */
...
typedef struct
{
  __IO uint32_t OPA_CR;
} OPA_TypeDef;

/* RNG Registers */
typedef struct
{
  __IO uint32_t RNG_CR;
  __IO uint32_t RNG_SR;
  __IO uint32_t RNG_DR;
} RNG_TypeDef;

/* DVP Registers */
typedef struct
{
  __IO uint8_t DVP_CR0;           
  __IO uint8_t DVP_CR1;           
  __IO uint8_t DVP_IER;           
  __IO uint8_t Reserved0;        
  __IO uint16_t DVP_ROW_NUM;     
  __IO uint16_t DVP_COL_NUM;     
  __IO uint32_t DVP_DMA_BUF0;    
  __IO uint32_t DVP_DMA_BUF1;     
  __IO uint8_t DVP_IFR;          
  __IO uint8_t DVP_STATUS;           
  __IO uint16_t Reserved1;            
  __IO uint16_t DVP_ROW_CNT;     
  __IO uint16_t Reserved2;           
  __IO uint16_t DVP_HOFFCNT;      
  __IO uint16_t DVP_VST;          
  __IO uint16_t DVP_CAPCNT;      
  __IO uint16_t DVP_VLINE;          
  __IO uint32_t DVP_DR;
} DVP_TypeDef;
...
typedef struct
{
  ...
  __IO uint32_t USB_ENDP_CONFIG; 
  __IO uint32_t USB_ENDP_TYPE;      
...
#define OPA_BASE              ((uint32_t)0x40023804)
